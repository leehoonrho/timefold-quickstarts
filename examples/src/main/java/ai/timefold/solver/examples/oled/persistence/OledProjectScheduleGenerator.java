...
public class OledProjectScheduleGenerator extends LoggingMain {
    ...
    public static void main(String[] args) {
        OledProjectScheduleGenerator generator = new OledProjectScheduleGenerator();
    ...
    public OledProjectScheduleGenerator() {
        solutionFileIO = new OledProjectScheduleSolutionFileIO();
        outputDir = new File(CommonApp.determineDataDir(CloudBalancingApp.DATA_DIR_NAME), "unsolved");
        checkConfiguration();
    }

    public OledProjectScheduleGenerator(boolean withoutDao) {
        if (!withoutDao) {

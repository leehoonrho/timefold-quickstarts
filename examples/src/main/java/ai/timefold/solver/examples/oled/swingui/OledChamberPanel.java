...
public class OledChamberPanel extends JPanel {
    ...
    public OledChamberPanel(CloudBalancingPanel cloudBalancingPanel, CloudComputer computer) {
    ...
    private class CloudBar extends JPanel {
        ...
        protected void paintComponent(Graphics g) {
            ...
            int offsetValue = 0;
            for (CloudProcess process : OledChamberPanel.this.processList) {

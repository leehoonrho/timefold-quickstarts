...
import ai.timefold.solver.examples.cloudbalancing.swingui.CloudComputerPanel;
...
public class OledSchedulePanel extends SolutionPanel<OledProjectSchedule> {
    ...
    private class CloudProcessAction extends AbstractAction {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            int result = JOptionPane.showConfirmDialog(OledSchedulePanel.this.getRootPane(), listFieldsPanel,

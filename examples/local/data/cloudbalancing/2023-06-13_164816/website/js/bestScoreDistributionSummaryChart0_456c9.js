...
var chart_bestScoreDistributionSummaryChart0_456c9 = new Chart(document.getElementById('chart_bestScoreDistributionSummaryChart0_456c9'), {
    type: 'boxplot',
    data: {
        labels: [
...
window.addEventListener('beforeprint', () => {
  chart_bestScoreDistributionSummaryChart0_456c9.resize(1280, 720);
});
window.addEventListener('afterprint', () => {
  chart_bestScoreDistributionSummaryChart0_456c9.resize();
});
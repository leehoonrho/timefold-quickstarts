...
var chart_bestScoreSummaryChart0_cf1ba = new Chart(document.getElementById('chart_bestScoreSummaryChart0_cf1ba'), {
    type: 'bar',
    data: {
        labels: [
...
window.addEventListener('beforeprint', () => {
  chart_bestScoreSummaryChart0_cf1ba.resize(1280, 720);
});
window.addEventListener('afterprint', () => {
  chart_bestScoreSummaryChart0_cf1ba.resize();
});
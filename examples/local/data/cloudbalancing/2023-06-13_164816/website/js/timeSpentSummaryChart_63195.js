...
var chart_timeSpentSummaryChart_63195 = new Chart(document.getElementById('chart_timeSpentSummaryChart_63195'), {
    type: 'bar',
    data: {
        labels: [
...
,
                  data: [
                    300001, 300000, 300000, 300000, 300000
                  ]
                }, 
{
                  label: 'TABU_SEARCH',
                ...
                }, 
{
                  ...
                  ,
                  data: [
                    300000, 300000, 300001, 300000, 300000
                  ]
                }, 
{
...
window.addEventListener('beforeprint', () => {
  chart_timeSpentSummaryChart_63195.resize(1280, 720);
});
window.addEventListener('afterprint', () => {
  chart_timeSpentSummaryChart_63195.resize();
});